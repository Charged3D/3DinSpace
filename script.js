document.addEventListener("DOMContentLoaded", () => {
    ...
    const scenes = [
        ...
        { video: "scene4.mp4", class: "bottom-center", text: "Місячні бази піддаються великому ризику від космічної радіації, яка є серйозною загрозою для здоров'я астронавтів. Без належного захисту від радіації, умови на Місяці можуть стати надзвичайно небезпечними для довготривалого перебування. Це одна з основних проблем, яку потрібно вирішити для стабільного життя на Місяці." },
        { video: "scene5.mp4", class: "top-center", text: "3D-принтери, використовуючи місцеві матеріали, такі як лунний ґрунт, можуть створювати конструкції, здатні захистити від космічної радіації. Використання таких технологій дозволяє будувати міцні та захищені бази, що гарантують безпечні умови для життєдіяльності на Місяці, забезпечуючи надійний захист від екстремальних умов навколишнього середовища." },
